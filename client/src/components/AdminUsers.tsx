...
function AdminUsers() {
  ...
  return (
    <UsersContainer>
      ...
      <AdminAddForm formDisplay={addFormDisplay} setFormDisplay={setAddFormDisplay} users={users} setUsers={setUsersProp} />
      <AdminEditForm formDisplay={addEditDisplay} setFormDisplay={setEditFormDisplay} user={user} setUsers={setUsersProp} />
      <UserWrapper>
